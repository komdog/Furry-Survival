...
SWEP.Gun 					= ("yz_fiveseven")					-- must be the name of your swep
...
SWEP.Base					= "yz_gun_base"
SWEP.Spawnable				= true
SWEP.UseHands 				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater 		= false

SWEP.Primary.Sound			= "weapons/2fiveseven/fiveseven-1.wav"		-- Script that calls the primary fire sound
